...
import javax.servlet.FilterConfig;   // thêm import này
...
public class AuthenticationFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        // Nếu cần load config khi khởi tạo filter thì viết ở đây
        // Không dùng thì để trống
    }
    ...
    @Override
    public void destroy() {
        // Nếu có resource cần cleanup thì làm ở đây
        // Không dùng thì để trống
    }
}
